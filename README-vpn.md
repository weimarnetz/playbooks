...
Dieses Ansible-Playbook automatisiert die Einrichtung von VPN-Servern für die Weimarer Freifunk-Community. Es konfiguriert WireGuard für die Server-zu-Server Verbindungen und OLSR für das Routing zwischen den VPN-Servern.
...
- **OLSR**: Optimized Link State Routing Protocol für das Mesh-Routing zwischen den Servern über WireGuard
...
- Webserver mit statischem JSON-Endpoint (`/freifunk/vpn/`)
- fastd für Router-Verbindungen
- IP-Masquerading für Pakete außerhalb 10.0.0.0/8
...
**Hinweis:** Der Output wird immer angezeigt (auch bei wiederholten Playbook-Läufen ohne Änderungen), sodass der öffentliche Schlüssel jederzeit verfügbar ist.
...
Beim Ausführen des Playbooks werden abgefragt:
- Öffentlicher Schlüssel des Peers (Debian 10 Server)
- Public IP-Adresse oder Hostname des Peers
